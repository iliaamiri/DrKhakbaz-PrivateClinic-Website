...
<html lang="en">
  <head>
	...
	<link rel="icon" href="images/header-image.png" type="image/ico" />
    ...
    <!-- JQVMap -->
    <link href="panel/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    ...
    <link href="panel/build/css/custom.min.css" rel="stylesheet">
      <link href="panel/vendors/dropzone/dist/min/dropzone.min.css" rel="stylesheet">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix" style="font-family: 'Arvo';">
              ...
              <div class="profile_info">
                  <span>Welcome <b style="color: #d31e00;">My Lord</b>,</span>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="font-family: 'Lato';">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a style=""><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="profile">Dashboard</a></li>
                      <li><a href="profile?parts=">Witcher's Personal Info</a></li>
                      <li><a href="index3.html">Witcher's Slaves</a></li>
                    </ul>
                  </li>
                  <li><a style=""><i class="fa fa-edit"></i> Slaves <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="profile?parts=calendar">Calendar</a></li>
                    </ul>
                  </li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="profile?parts=landingpages"><i class="fa fa-laptop"></i> Landing Page <span class="label label-success pull-right">Coming Soon</span></a></li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?= $user_info['Username']?>
