            ...
            <ul>
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <div class="tp-caption small_title customin customout start"
                         ...
                         data-start="1400"
                         data-easing="Back.easeInOut"
                         data-endspeed="300"><a href="#" class="btn btn-primary btn-lg">Make an Appoinment</a>
                    </div>
    ...
    <div class="container">
        <div class="general-row">
            <div class="general-title text-center">
                <h3>What we offer?</h3>
                <p class="lead">We Provide best Treatment for  our Patients</p>
            </div>
            <div class="custom-services">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 first">
                    <div class="service_box">
                        ...
                        <div class="title">
                            <h3>Amazing Medical Facility</h3>
                        </div><!-- end title -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 last">
                    <div class="service_box">
                        ...
                        <div class="title">
                            <h3>24 Hours Emergency Services</h3>
                        </div><!-- end title -->
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur euismod enim a metus adipiscing aliquam. Vestibulum in vestibulum lorem.</p>
                        <a href="#" class="readmore">Read more</a>
                    </div><!-- end service_box -->
            ...
            <div id="owl-blog" class="owl-carousel">
                <div class="item">
                    <div class="blog-carousel">
                        ...
                        <div class="blog-carousel-header">
                            <h3><a title="" href="blog-single.html">Patient and Visitor Guide</a></h3>
                ...
                <div class="item">
                    <div class="blog-carousel">
                        ...
                        <div class="blog-carousel-header">
                            <h3><a title="" href="blog-single.html">Nutritional Personal Consultation</a></h3>
                            <div class="blog-carousel-meta">
                                <span><i class="fa fa-calendar"></i> April 01, 2014</span>
                                <span><i class="fa fa-comment"></i> <a href="#">03 Comments</a></span>
                                <span><i class="fa fa-eye"></i> <a href="#">84 Views</a></span>
                ...
                <div class="item">
                    <div class="blog-carousel">
                        ...
                        <div class="blog-carousel-header">
                            <h3><a title="" href="blog-single.html">Center for Medical Technology </a></h3>
                            <div class="blog-carousel-meta">
                                <span><i class="fa fa-calendar"></i> April 01, 2014</span>
                                <span><i class="fa fa-comment"></i> <a href="#">03 Comments</a></span>
                                <span><i class="fa fa-eye"></i> <a href="#">84 Views</a></span>
...
<div class="white-wrapper">
    <div class="container">
        <div class="general_row">
            ...
            <div class="carousel_widget">
                <div class="team_widget">
                    <ul id="owl-testimonial-widget" class="owl-carousel">
                        <li>
                            <img src="demos/team_01.png" class="img-responsive img-circle alignleft" alt="">
                        ...
                        <li>
                            <img src="demos/team_02.png" class="img-responsive img-circle alignleft" alt="">
        ...
        <div class="row">
            ...
            <p class="lead custom_lead text-center">Trusted by some of the world's smartest partners</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="client_logo">
                    <a href="#" title="">
                        <img src="demos/client_logo_01.png" class="img-responsive" alt="">
                    </a>
                </div><!-- end client_logo -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="client_logo">
                    <a href="#" title="">
                        <img src="demos/client_logo_02.png" class="img-responsive" alt="">
                    </a>
                </div><!-- end client_logo -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="client_logo">
                    <a href="#" title="">
                        <img src="demos/client_logo_03.png" class="img-responsive" alt="">
                    </a>
                </div><!-- end client_logo -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="client_logo">
                    <a href="#" title="">
                        <img src="demos/client_logo_04.png" class="img-responsive" alt="">
                    </a>
                </div><!-- end client_logo -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
...
<div class="custom-wrapper">
    <div class="container">
        <div class="newsletter_wrapper">
            ...
            <h3>Over <mark>100,000</mark> People Trust us worldwide. Get free Health<br>
                Tips, Subscribe us</h3>
            ...
            <div class="row margin-top">
                <form id="loginform" method="post" name="loginform">
                    ...
                    <button class="btn btn-default btn-lg">Subscribe Now</button>
                </form>
            </div>
